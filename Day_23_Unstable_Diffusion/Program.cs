...
Console.WriteLine($"{GetEmptyGroundTiles(1)}");
Console.WriteLine($" {GetEmptyGroundTiles(2)}");
...
long GetEmptyGroundTiles(int part)
{
	if (part ==2)
		return MoveElves(initialState.ToHashSet());
